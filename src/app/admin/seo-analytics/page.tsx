  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between border-b border-slate-800 pb-4">
        ...
        <button
          onClick={refreshLogs}
          className="bg-slate-800 hover:bg-slate-700 text-ukta-gold px-3.5 py-2 rounded-xl text-xs font-bold flex items-center gap-1.5 border border-ukta-gold/30"
        >
      ...
      <div className="bg-gradient-to-r from-slate-950 via-slate-900 to-ukta-navy p-6 rounded-3xl border-2 border-ukta-gold/50 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Globe className="w-5 h-5 text-ukta-gold" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
          ...
          <div className="bg-slate-900 p-3.5 rounded-2xl border border-slate-800">
            ...
            <span className="font-bold text-ukta-gold block mt-0.5">G-UKTA2026SEO (Active)</span>
          </div>
        </div>
      </div>
                ...
                <tr key={evt.id} className="hover:bg-slate-900/50">
                  ...
                  <td className="p-4">
                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                      ...
                      evt.eventName === 'membership_signup' ? 'bg-ukta-gold/20 text-ukta-gold' :
